...
if($_SERVER['REQUEST_METHOD'] && isset($_POST['updateQuantity'])) {
	$updateQty = $retailProduct->updateRetailQty($_POST);
}
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="row">
			<div class="col-sm-12">
				<h1 class="page-header">Update retail product quantity</h1>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
					...
					<select class="form-control" name="retailProductId" id="retailProduct">
